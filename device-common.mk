...
# Init files
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/init/etc/fstab.samsungexynos7870:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.samsungexynos7870 \
    $(LOCAL_PATH)/configs/init/etc/init.baseband.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.baseband.rc \
    $(LOCAL_PATH)/configs/init/etc/init.rilchip.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.rilchip.rc \
    $(LOCAL_PATH)/configs/init/etc/init.rilcommon.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.rilcommon.rc \
    $(LOCAL_PATH)/configs/init/etc/init.samsung.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.samsung.rc \
    $(LOCAL_PATH)/configs/init/etc/init.samsungexynos7870.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.samsungexynos7870.rc \
    $(LOCAL_PATH)/configs/init/etc/init.samsungexynos7870.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.samsungexynos7870.usb.rc \
    $(LOCAL_PATH)/configs/init/etc/init.wifi.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.wifi.rc \
    $(LOCAL_PATH)/configs/init/etc/ueventd.samsungexynos7870.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
